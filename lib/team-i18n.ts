...
export const TEAM_UI = {
  en: {
    ...
    inviteeLanguageLabel: "Invitee's Language",
    sendingInvite: "Sending…",
    sendInviteButton: "Send Invite →",
    generateLinkExplainer: "Or generate a link and share it yourself. Each link is valid for 7 days and can only be used once.",
    generateNewLink: "+ Generate New Invite Link",
    activeLinksCount: (n: number) => `Active Links (${n})`,
    daysLeftSuffix: (n: number) => `${n}d left`,
    copiedShort: "✓ Copied!",
    shareLinkBtn: "Share Link",
    revoke: "Revoke",
    usedCount: (n: number) => `Used (${n})`,
    usedOnDate: (date: string) => `Used on ${date}`,
    noInviteLinksYet: "No invite links yet. Generate one above and share it with your team.",
  ...
  id: {
    ...
    sendInviteByEmail: "Kirim Undangan lewat Email",
    invitationSentSuccess: "Undangan berhasil dikirim.",
    firstNamePlaceholder: "Nama depan",
    inviteeLanguageLabel: "Bahasa Penerima Undangan",
    sendingInvite: "Mengirim…",
    sendInviteButton: "Kirim Undangan →",
    generateLinkExplainer: "Atau buat tautan dan bagikan sendiri. Setiap tautan berlaku 7 hari dan hanya bisa digunakan sekali.",
    generateNewLink: "+ Buat Tautan Undangan Baru",
    activeLinksCount: (n: number) => `Tautan Aktif (${n})`,
    daysLeftSuffix: (n: number) => `${n} hari lagi`,
    copiedShort: "✓ Tersalin!",
    shareLinkBtn: "Bagikan Tautan",
    revoke: "Cabut",
    usedCount: (n: number) => `Digunakan (${n})`,
    usedOnDate: (date: string) => `Digunakan pada ${date}`,
    noInviteLinksYet: "Belum ada tautan undangan. Buat satu di atas dan bagikan dengan tim Anda.",
    // TeamLeaderDashboard fallback
