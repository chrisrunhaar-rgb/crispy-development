...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/courses`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${base}/waypoint`, lastModified: now, changeFrequency: "monthly" as const, priority: 0.7 },
