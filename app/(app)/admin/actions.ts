  ...
  if (email) {
    ...
    if (resendKey) {
      ...
      if (language === "id") {
        ...
        const pathwayLabel = pathway === "team" ? "seorang pemimpin tim" : "anggota komunitas";
        subject = "Anda diundang untuk bergabung dengan Crispy Leaders";
        html = `<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;padding:40px 24px;background:#ffffff;"><div style="width:3px;height:36px;background:#E07540;margin-bottom:24px;"></div><p style="font-size:10px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:#E07540;margin:0 0 12px 0;">Anda Diundang</p><h1 style="font-size:24px;font-weight:800;color:#1B3A6B;line-height:1.15;margin:0 0 16px 0;">Bergabung dengan Crispy Leaders.</h1><p style="font-size:15px;line-height:1.75;color:#555555;margin:0 0 8px 0;">${greeting}</p><p style="font-size:15px;line-height:1.75;color:#555555;margin:0 0 32px 0;">Anda telah diundang secara pribadi untuk bergabung dengan Crispy Leaders sebagai ${pathwayLabel}. Klik tombol di bawah untuk membuat akun dan memulai.</p><a href="${inviteUrl}" style="display:inline-block;background:#1B3A6B;color:#ffffff;font-size:14px;font-weight:700;letter-spacing:0.04em;text-decoration:none;padding:14px 28px;margin-bottom:32px;">Terima Undangan &rarr;</a><p style="font-size:12px;line-height:1.6;color:#9b9b9b;margin:0 0 24px 0;">Undangan ini berlaku selama 7 hari. Jika Anda tidak menduga akan menerima email ini, abaikan saja.</p><p style="font-size:12px;color:#9b9b9b;margin:0 0 20px 0;">Bersama Anda di jalur ini,<br/><strong style="color:#1B3A6B;">Tim Crispy Leaders</strong></p><div style="border-top:1px solid #e8e4df;padding-top:24px;margin-top:8px;"><img src="https://www.crispyleaders.com/logo-icon-dark-badge.png" alt="Crispy Leaders" width="48" height="48" style="display:block;margin-bottom:8px;" /><p style="font-size:12px;color:#9b9b9b;margin:0;">crispyleaders.com</p></div></div>`;
      } else {
