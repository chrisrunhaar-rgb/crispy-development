...
const ENNEAGRAM_TYPES: Record<number, EnneagramTypeData> = {
  1: {
    ...
    tagline: { en: "The Principled Idealist", id: "Si Idealis Berprinsip" },
    ...
    motivation: { en: "To be right, to improve themselves and the world, and to do things correctly.", id: "Menjadi benar, meningkatkan diri dan dunia, dan melakukan segala sesuatu dengan benar." },
    fear: { en: "Being wrong, incompetent, or not doing enough to make things better.", id: "Menjadi salah, tidak kompeten, atau tidak melakukan cukup untuk membuat hal-hal lebih baik." },
    ...
    communication: { en: "Practice accepting imperfection in yourself and others. Learn to balance idealism with compassion and forgiveness.", id: "Praktikkan menerima ketidaksempurnaan dalam diri Anda dan orang lain. Pelajari cara menyeimbangkan idealisme dengan belas kasih dan pengampunan." },
    crossCultural: { en: "Your sense of justice is a strength, but be aware that different cultures have different standards. Listen to understand before correcting.", id: "Rasa keadilan Anda adalah kekuatan, tetapi sadari bahwa budaya yang berbeda memiliki standar yang berbeda. Dengarkan untuk memahami sebelum mengoreksi." },
  },
  2: {
    number: 2,
    name: { en: "The Helper", id: "Si Penolong" },
    tagline: { en: "The Caring Supporter", id: "Si Pendukung Peduli" },
    ...
    motivation: { en: "To be loved, appreciated, and needed; to help others and feel valued.", id: "Untuk dicintai, dihargai, dan dibutuhkan; untuk membantu orang lain dan merasa berharga." },
    fear: { en: "Being unloved, rejected, or of no value to others.", id: "Tidak dicintai, ditolak, atau tidak berharga bagi orang lain." },
    ...
    communication: { en: "Learn to set healthy boundaries and prioritize your own needs. Your value isn't dependent on what you do for others.", id: "Pelajari cara menetapkan batas yang sehat dan prioritaskan kebutuhan Anda sendiri. Nilai Anda tidak bergantung pada apa yang Anda lakukan untuk orang lain." },
    crossCultural: { en: "Your warmth translates well across cultures, but be aware that different cultures show appreciation differently. Ask directly what people need.", id: "Kehangatan Anda diterjemahkan dengan baik di berbagai budaya, tetapi sadari bahwa budaya yang berbeda menunjukkan apresiasi secara berbeda. Tanya secara langsung apa yang dibutuhkan orang." },
  },
  3: {
    number: 3,
    name: { en: "The Achiever", id: "Si Pencapai" },
    tagline: { en: "The Goal-Oriented Performer", id: "Si Pemain yang Berorientasi pada Tujuan" },
    color: "oklch(65% 0.25 40)",
    colorLight: "oklch(92% 0.03 40)",
    overview: { en: "Type 3s are driven to succeed, excel, and be recognized for their accomplishments. They are energetic, efficient, and focused on results. They adapt easily to different environments.", id: "Tipe 3 didorong untuk sukses, unggul, dan diakui atas pencapaian mereka. Mereka energik, efisien, dan fokus pada hasil. Mereka mudah beradaptasi dengan lingkungan yang berbeda." },
    motivation: { en: "To succeed, be recognized, and be valued for their achievements and effectiveness.", id: "Untuk sukses, diakui, dan dihargai atas prestasi dan efektivitas mereka." },
    fear: { en: "Being worthless, ineffective, or unsuccessful; failure and being exposed as incompetent.", id: "Tidak berharga, tidak efektif, atau tidak berhasil; kegagalan dan terbukti tidak kompeten." },
    ...
    communication: { en: "Remember that your worth isn't tied to your accomplishments. Take time to connect with your authentic self and deeper relationships.", id: "Ingat bahwa nilai Anda tidak terikat pada pencapaian Anda. Ambil waktu untuk terhubung dengan diri autentik Anda dan hubungan yang lebih dalam." },
    crossCultural: { en: "Your drive for results is valuable, but different cultures define success differently. Build relationships before pushing for outcomes.", id: "Dorongan Anda untuk hasil berharga, tetapi budaya yang berbeda mendefinisikan kesuksesan secara berbeda. Bangun hubungan sebelum mendorong hasil." },
  },
  4: {
    number: 4,
    name: { en: "The Individualist", id: "Si Individualis" },
    tagline: { en: "The Authentic Expresser", id: "Si Pengekspresi Autentik" },
    color: "oklch(55% 0.20 310)",
    colorLight: "oklch(88% 0.03 310)",
    overview: { en: "Type 4s are creative, introspective, and driven by a need to understand themselves and express their unique identity. They are sensitive to emotions and often feel misunderstood.", id: "Tipe 4 kreatif, introspektif, dan didorong oleh kebutuhan untuk memahami diri mereka sendiri dan mengekspresikan identitas unik mereka. Mereka sensitif terhadap emosi dan sering merasa disalahpahami." },
    motivation: { en: "To discover their true identity, express their uniqueness, and be understood in their depth and complexity.", id: "Untuk menemukan identitas sejati mereka, mengekspresikan keunikan mereka, dan dipahami dalam kedalaman dan kompleksitas mereka." },
    fear: { en: "Being ordinary, not having a unique identity, or being fundamentally flawed or defective.", id: "Menjadi biasa, tidak memiliki identitas unik, atau cacat atau rusak secara fundamental." },
    ...
    communication: { en: "Your emotional depth is a gift, but try to move beyond self-focus to understand others. Find healthy outlets for your intensity.", id: "Kedalaman emosional Anda adalah hadiah, tetapi cobalah bergerak melampaui fokus diri untuk memahami orang lain. Temukan saluran sehat untuk intensitas Anda." },
    crossCultural: { en: "Your authenticity is respected, but cultural norms around emotional expression vary. Honor both your needs and cultural context.", id: "Autentisitas Anda dihormati, tetapi norma budaya seputar ekspresi emosional bervariasi. Hormati kebutuhan Anda dan konteks budaya." },
  },
  5: {
    number: 5,
    name: { en: "The Investigator", id: "Si Peneliti" },
    tagline: { en: "The Knowledge Seeker", id: "Si Pencari Pengetahuan" },
    color: "oklch(50% 0.15 260)",
    colorLight: "oklch(88% 0.03 260)",
    overview: { en: "Type 5s are curious, analytical, and driven by a need to understand how things work. They are independent thinkers who value knowledge and expertise.", id: "Tipe 5 penasaran, analitis, dan didorong oleh kebutuhan untuk memahami cara kerja hal-hal. Mereka adalah pemikir independen yang menghargai pengetahuan dan keahlian." },
    motivation: { en: "To gain knowledge and understanding, to be competent and independent, and to explore ideas deeply.", id: "Untuk mendapatkan pengetahuan dan pemahaman, menjadi kompeten dan mandiri, dan mengeksplorasi ide secara mendalam." },
    fear: { en: "Being incompetent or useless; lacking knowledge or understanding; being perceived as ignorant.", id: "Menjadi tidak kompeten atau tidak berguna; kekurangan pengetahuan atau pemahaman; dianggap bodoh." },
    ...
    communication: { en: "Balance your need for knowledge with connection. Share what you know in accessible ways. Engage emotionally even when uncomfortable.", id: "Seimbangkan kebutuhan Anda akan pengetahuan dengan koneksi. Bagikan apa yang Anda tahu dengan cara yang dapat diakses. Terlibat secara emosional bahkan saat tidak nyaman." },
    crossCultural: { en: "Your analytical skills are valuable across cultures. However, remember that knowledge is interpreted differently in different contexts. Be humble.", id: "Keterampilan analitis Anda berharga di berbagai budaya. Namun, ingat bahwa pengetahuan ditafsirkan secara berbeda dalam konteks yang berbeda. Jadilah rendah hati." },
  },
  6: {
    number: 6,
    name: { en: "The Loyalist", id: "Si Setia" },
    tagline: { en: "The Committed Team Member", id: "Si Anggota Tim yang Berkomitmen" },
    color: "oklch(55% 0.18 45)",
    colorLight: "oklch(90% 0.02 45)",
    overview: { en: "Type 6s are loyal, responsible, and driven by a need for security and trust. They are team players who value belonging and are naturally cautious.", id: "Tipe 6 setia, bertanggung jawab, dan didorong oleh kebutuhan akan keamanan dan kepercayaan. Mereka adalah pemain tim yang menghargai rasa memiliki dan secara alami berhati-hati." },
    motivation: { en: "To be secure, to belong to a trusted group, to be dependable, and to prepare for potential risks.", id: "Untuk aman, menjadi bagian dari kelompok terpercaya, dapat diandalkan, dan mempersiapkan risiko potensial." },
    fear: { en: "Being without support, betrayed, or facing danger without adequate protection or guidance.", id: "Tanpa dukungan, dikhianati, atau menghadapi bahaya tanpa perlindungan atau panduan yang memadai." },
    ...
    communication: { en: "Work on building trust in yourself and others. Not every scenario is a worst-case scenario. Practice risk-taking in safe environments.", id: "Kerjakan membangun kepercayaan pada diri sendiri dan orang lain. Tidak setiap skenario adalah skenario terburuk. Praktikkan pengambilan risiko di lingkungan yang aman." },
    crossCultural: { en: "Your reliability is valued everywhere. However, be aware that different cultures show trust differently. Give people time to earn trust.", id: "Keandalan Anda dihargai di mana saja. Namun, sadari bahwa budaya yang berbeda menunjukkan kepercayaan secara berbeda. Beri orang waktu untuk mendapatkan kepercayaan." },
  },
  7: {
    number: 7,
    name: { en: "The Enthusiast", id: "Si Antusias" },
    tagline: { en: "The Optimistic Adventurer", id: "Si Petualang Optimis" },
    color: "oklch(70% 0.20 80)",
    colorLight: "oklch(92% 0.03 80)",
    overview: { en: "Type 7s are upbeat, spontaneous, and driven by a need for excitement and new experiences. They are optimistic, creative, and hate feeling trapped or bored.", id: "Tipe 7 ceria, spontan, dan didorong oleh kebutuhan akan kegembiraan dan pengalaman baru. Mereka optimis, kreatif, dan benci merasa terjebak atau bosan." },
    motivation: { en: "To have fun, experience joy and stimulation, avoid pain and boredom, and keep options open.", id: "Untuk bersenang-senang, mengalami kegembiraan dan stimulasi, menghindari rasa sakit dan kebosanan, dan membuat pilihan tetap terbuka." },
    fear: { en: "Missing out, being trapped, experiencing pain or suffering, or being bored and unfulfilled.", id: "Ketinggalan, merasa terjebak, mengalami rasa sakit atau penderitaan, atau bosan dan tidak puas." },
    ...
    communication: { en: "Develop depth in your relationships and work. Facing discomfort leads to growth. Practice staying present with difficult emotions.", id: "Kembangkan kedalaman dalam hubungan dan pekerjaan Anda. Menghadapi ketidaknyamanan menghasilkan pertumbuhan. Praktikkan tetap hadir dengan emosi yang sulit." },
    crossCultural: { en: "Your enthusiasm for new experiences is infectious, but respect that some cultures value stability over novelty. Find balance.", id: "Antusiasme Anda untuk pengalaman baru menular, tetapi hormati bahwa beberapa budaya menghargai stabilitas daripada kebaruan. Temukan keseimbangan." },
  },
  8: {
    number: 8,
    name: { en: "The Challenger", id: "Si Penegak" },
    tagline: { en: "The Bold Protector", id: "Si Pelindung Berani" },
    ...
    motivation: { en: "To be strong and in control, to protect themselves and others, and to avoid being vulnerable or dependent.", id: "Untuk menjadi kuat dan mengendalikan, melindungi diri sendiri dan orang lain, dan menghindari kerentanan atau ketergantungan." },
    fear: { en: "Being controlled, weak, or betrayed; being vulnerable or taken advantage of.", id: "Dikendalai, lemah, atau dikhianati; menjadi rentan atau dimanfaatkan." },
    ...
    communication: { en: "Soften your approach with those you care about. Vulnerability is strength, not weakness. Let people help you sometimes.", id: "Lunak pendekatan Anda dengan mereka yang Anda sayangi. Kerentanan adalah kekuatan, bukan kelemahan. Biarkan orang membantu Anda kadang-kadang." },
    crossCultural: { en: "Your directness can be misinterpreted as rudeness in some cultures. Adapt your communication while maintaining your authenticity.", id: "Ketegasan Anda dapat disalahartikan sebagai kasar dalam beberapa budaya. Sesuaikan komunikasi Anda sambil mempertahankan autentisitas Anda." },
  },
  9: {
    number: 9,
    name: { en: "The Peacemaker", id: "Si Pembuat Perdamaian" },
    tagline: { en: "The Harmonious Mediator", id: "Si Mediator Harmonis" },
    color: "oklch(55% 0.12 140)",
    colorLight: "oklch(88% 0.02 140)",
    overview: { en: "Type 9s are easygoing, accommodating, and driven by a need for peace and harmony. They are natural mediators who seek to avoid conflict and create unity.", id: "Tipe 9 santai, akomodasi, dan didorong oleh kebutuhan untuk perdamaian dan harmoni. Mereka adalah mediator alami yang berusaha menghindari konflik dan menciptakan kesatuan." },
    motivation: { en: "To maintain peace, avoid conflict, and ensure everyone feels heard and included.", id: "Untuk mempertahankan perdamaian, menghindari konflik, dan memastikan semua orang merasa didengar dan disertakan." },
    fear: { en: "Conflict, disruption, disconnection, or being forced to take sides.", id: "Konflik, gangguan, putus hubungan, atau dipaksa memilih pihak." },
    ...
    communication: { en: "Your voice matters. Express your own needs and preferences, not just go along with others. Take a stand when needed for important matters.", id: "Suara Anda penting. Ekspresikan kebutuhan dan preferensi Anda sendiri, jangan hanya ikut saja dengan orang lain. Ambil posisi tegas ketika diperlukan untuk hal-hal penting." },
      ...
      {!done && href && (
        <Link
          ...
          style={{
            ...
            fontSize: "0.62rem",
            fontWeight: 700,
            color: isSubscriber ? "oklch(42% 0.08 260)" : "oklch(55% 0.10 45)",
            textDecoration: "none",
            alignSelf: "flex-end",
          }}
          onClick={e => e.stopPropagation()}
        ...
        >
          ...
          {!done && (
            <Link
              ...
              onClick={e => e.stopPropagation()}
            >
              {isSubscriber ? (lang === "id" ? "Ikuti tes →" : "Take test →") : (lang === "id" ? "🔒 Buka akses →" : "🔒 Unlock →")}
            </Link>
          )}
    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.625rem" }}>
        ...
        <CompactTile
          ...
          visual={enneagramScores && enneagramType && ENNEAGRAM_TYPES[enneagramType] ? <div style={{ width: 140, height: 140 }}><TypeCard type={ENNEAGRAM_TYPES[enneagramType]} lang={lang as "en" | "id"} isFlipped={false} onClick={() => {}} /></div> : <EmptyTileVisual />}
