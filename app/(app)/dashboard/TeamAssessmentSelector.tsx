...
const ASSESSMENTS = [
  ...
  { id: "myers-briggs", label: "Myers-Briggs (MBTI)", description: "Personality type framework", live: false },
  { id: "16-personalities", label: "16 Personalities", description: "In-depth personality profiles", live: false },
  { id: "enneagram", label: "Enneagram", description: "Core motivations & growth paths", live: false },
  { id: "big-five", label: "Big Five (OCEAN)", description: "Five-factor personality traits", live: false },
];
