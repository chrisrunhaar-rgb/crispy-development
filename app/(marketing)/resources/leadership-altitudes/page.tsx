...
const RESOURCE_SLUG = "leadership-altitudes";
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "Leadership Altitudes" },
            ]}
          />
        </div>
      </div>

      <LeadershipAltitudesClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="leadership-altitudes" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="leadership-altitudes" />
        </div>
      </div>
    </>
  );
