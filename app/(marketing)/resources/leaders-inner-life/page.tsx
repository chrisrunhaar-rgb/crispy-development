...
import LeadersInnerLifeClient from "./LeadersInnerLifeClient";

export const dynamic = "force-dynamic";

const RESOURCE_SLUG = "leaders-inner-life";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      />
      <Script
        id="sl-leaders-inner-life-ga-tracking"
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "The Leader's Inner Life" },
            ]}
          />
        </div>
      </div>

      <LeadersInnerLifeClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="leaders-inner-life" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="leaders-inner-life" />
        </div>
      </div>
    </>
  );
