...
const BIASES: Bias[] = [
  // Memory
  {
    ...
    crossCulturalNote_nl: "Leiders beoordelen het potentieel van een hele regio op basis van ——n recente, opvallende gebeurtenis in plaats van representatieve data.",
  },
  {
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Herhaalde negatieve clich—s over een cultuur op het hoofdkantoor worden door pure herhaling 'feiten', waardoor de verwachtingen van een leider al zijn vertekend voordat ze er aankomen.",
  },
  {
    name: "Tachypsychia",
    name_id: "Takipsikia",
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Expat-leiders denken te veel na over hun culturele blunders en geloven dat het lokale team hen constant beoordeelt — wat onnodige angst en sociale afstand cre—ert.",
  },
  {
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Na ——n bezoek aan een nieuw land gelooft een leider dat ze nu een cultuurexpert zijn — wat leidt tot te zelfverzekerde en vaak kostbare beslissingen.",
  },
  {
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Leiders verzetten zich tegen het aanpassen van bewezen thuislandstrategie—n aan lokale behoeften en geven de voorkeur aan het bekende boven het effectieve.",
  },
  {
    name: "Framing Effect",
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Twee of drie toevallige verkopen in een nieuwe markt worden ge—nterpreteerd als een trend, wat leidt tot voortijdige en kostbare schaalvergroting.",
  },
  {
    name: "Pessimism Bias",
  ...
  },
  {
    ...
    crossCulturalNote_nl: "Leiders onderschatten de tijd die nodig is om lokale bureaucratie—n te doorlopen, wat leidt tot gemiste deadlines en aanzienlijke budgetoverschrijdingen.",
  },
  // Belief
  {
  ...
  // Money
  {
    ...
    crossCulturalNote_nl: "Leiders blijven middelen steken in een falende buitenlandse dochteronderneming omdat ze te veel ego en tijd hebben ge—nvesteerd om toe te geven dat de strategie niet werkt.",
  },
  {
...
const counterStrategies = [
  ...
  { number: "5", en: "Practice cultural humility as a spiritual discipline — remember that you see through a glass darkly (1 Corinthians 13:12). Your perception is partial.", id: "Praktikkan kerendahan hati budaya sebagai disiplin rohani — ingat bahwa Anda melihat melalui kaca yang gelap (1 Korintus 13:12). Persepsi Anda hanya sebagian.", nl: "Beoefen culturele bescheidenheid als geestelijke discipline — onthoud dat je door een glas onduidelijk ziet (1 Korinti—rs 13:12). Je perceptie is gedeeltelijk." },
];

const reflectionQuestions = [
  { roman: "I", en: "Which of the six bias categories resonates most with patterns you notice in yourself?", id: "Kategori bias mana dari enam yang paling beresonansi dengan pola yang Anda perhatikan dalam diri Anda?", nl: "Welke van de zes biascategorie—n resoneert het meest met patronen die je in jezelf opmerkt?" },
