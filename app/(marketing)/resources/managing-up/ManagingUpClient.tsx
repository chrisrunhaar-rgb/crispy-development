...
const reflectionQuestions = [
  ...
  { roman: "V", en: "What is one thing you have been avoiding raising with your leader? What would faithfulness require you to do?", id: "Apa satu hal yang Anda hindari untuk diangkat dengan pemimpin Anda? Apa yang kesetiaan mengharuskan Anda lakukan?", nl: "Wat is ��n ding dat je hebt vermeden bij je leider te bespreken? Wat zou trouw van je vereisen?" },
