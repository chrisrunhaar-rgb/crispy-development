...
const leaderNeeds = [
  { number: "1", en_title: "Clarity, not confusion", id_title: "Kejelasan, bukan kebingungan", en_desc: "Your leader needs to know the state of what you are responsible for — without having to dig for it. This means proactive updates, concise reporting, and flagging problems early. The person who makes their leader's job easier earns trust quickly.", id_desc: "Pemimpin Anda perlu mengetahui keadaan apa yang Anda tanggung jawabi — tanpa harus menggalinya. Ini berarti pembaruan proaktif, pelaporan yang ringkas, dan tanda masalah awal." },
  { number: "2", en_title: "Honest intelligence, not flattery", id_title: "Kecerdasan yang jujur, bukan sanjungan", en_desc: "Leaders lose touch with reality when the people around them only tell them what they want to hear. Giving your leader accurate, honest information — even when it is uncomfortable — is a form of respect. Telling them what they want to hear is a form of sabotage.", id_desc: "Pemimpin kehilangan kontak dengan realitas ketika orang-orang di sekitar mereka hanya memberi tahu mereka apa yang ingin mereka dengar. Memberikan pemimpin Anda informasi yang akurat dan jujur — bahkan ketika itu tidak nyaman — adalah bentuk penghormatan." },
  { number: "3", en_title: "Solutions, not just problems", id_title: "Solusi, bukan hanya masalah", en_desc: "Anyone can bring problems to a leader. Leaders value people who bring problems AND a proposed way forward. Even if your suggestion is not used, coming with a solution signals that you are thinking at the right level and not just offloading.", id_desc: "Siapa saja bisa membawa masalah ke pemimpin. Pemimpin menghargai orang yang membawa masalah DAN cara maju yang diusulkan. Bahkan jika saran Anda tidak digunakan, datang dengan solusi memberi sinyal bahwa Anda berpikir pada tingkat yang tepat." },
  { number: "4", en_title: "Reliability and follow-through", id_title: "Keandalan dan tindak lanjut", en_desc: "Every leader carries a mental register of 'people I can count on' and 'people I have to chase.' The fastest way to gain influence with your leader is to be ruthlessly reliable — do what you say, when you said it, to the standard you agreed.", id_desc: "Setiap pemimpin membawa daftar mental 'orang yang bisa saya andalkan' dan 'orang yang harus saya kejar.' Cara tercepat untuk mendapatkan pengaruh dengan pemimpin Anda adalah menjadi sangat andal — lakukan apa yang Anda katakan, kapan Anda mengatakannya, sesuai standar yang Anda setujui." },
];

const principles = [
  { number: "1", en: "Understand your leader's goals, pressures, and blind spots — and align your communication accordingly.", id: "Pahami tujuan, tekanan, dan titik buta pemimpin Anda — dan selaraskan komunikasi Anda sesuai." },
  { number: "2", en: "Match your communication medium to the message — not everything needs an email; not everything can wait.", id: "Sesuaikan media komunikasi Anda dengan pesan — tidak semua butuh email; tidak semua bisa menunggu." },
  { number: "3", en: "Pick the right moment — a leader under pressure will not hear well. Timing is part of communicating upward.", id: "Pilih momen yang tepat — pemimpin yang berada di bawah tekanan tidak akan mendengar dengan baik. Waktu adalah bagian dari berkomunikasi ke atas." },
  { number: "4", en: "Disagree respectfully and privately — raise concerns in private; once a decision is made, support it publicly.", id: "Tidak setuju dengan hormat dan pribadi — angkat kekhawatiran secara pribadi; setelah keputusan dibuat, dukung secara publik." },
  { number: "5", en: "Keep your leader off guard only on good surprises — no leader should hear bad news from someone else first.", id: "Buat pemimpin Anda tidak terganggu hanya pada kejutan yang baik — tidak ada pemimpin yang harus mendengar berita buruk dari orang lain lebih dulu." },
];

const commonMistakes = [
  { en: "Waiting to be asked — proactive communication is managing up; reactive communication is just surviving.", id: "Menunggu ditanya — komunikasi proaktif adalah managing up; komunikasi reaktif hanyalah bertahan." },
  { en: "Overloading your leader with detail — they need the headline and the options, not the full narrative.", id: "Membebani pemimpin Anda dengan detail — mereka membutuhkan judul utama dan pilihan, bukan narasi lengkap." },
  ...
  { en: "Managing sideways but not upward — great peer relationships don't substitute for managing your leader relationship.", id: "Mengelola ke samping tetapi tidak ke atas — hubungan rekan yang baik tidak menggantikan mengelola hubungan pemimpin Anda." },
];

const reflectionQuestions = [
  { roman: "I", en: "Does your leader trust your judgment? How do you know? What evidence supports or challenges that?", id: "Apakah pemimpin Anda mempercayai penilaian Anda? Bagaimana Anda tahu? Bukti apa yang mendukung atau menantang itu?" },
  { roman: "II", en: "What does your leader most need from you right now that you are not currently providing?", id: "Apa yang paling dibutuhkan pemimpin Anda dari Anda saat ini yang tidak Anda berikan?" },
  { roman: "III", en: "Have you ever given a leader bad news too late? What were the consequences, and what would you do differently?", id: "Pernahkah Anda memberikan pemimpin berita buruk terlambat? Apa konsekuensinya, dan apa yang akan Anda lakukan secara berbeda?" },
  { roman: "IV", en: "How does your cultural context shape expectations about how one communicates with those in authority?", id: "Bagaimana konteks budaya Anda membentuk harapan tentang cara seseorang berkomunikasi dengan mereka yang berkuasa?" },
  { roman: "V", en: "What is one thing you have been avoiding raising with your leader? What would faithfulness require you to do?", id: "Apa satu hal yang Anda hindari untuk diangkat dengan pemimpin Anda? Apa yang kesetiaan mengharuskan Anda lakukan?" },
  { roman: "VI", en: "How does submitting to authority (Romans 13, 1 Peter 2) shape your theology of managing up?", id: "Bagaimana tunduk pada otoritas (Roma 13, 1 Petrus 2) membentuk teologi Anda tentang managing up?" },
];
    ...
    <div style={{ fontFamily: "Montserrat, sans-serif", background: offWhite, minHeight: "100vh" }}>
      ...
      <div style={{ background: navy, padding: "80px 24px 72px" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <button onClick={handleSave} disabled={saved || isPending} style={{ padding: "12px 28px", borderRadius: 12, border: "none", cursor: saved ? "default" : "pointer", fontFamily: "Montserrat, sans-serif", fontSize: 14, fontWeight: 700, background: saved ? "oklch(35% 0.08 260)" : orange, color: offWhite }}>
      ...
      <div style={{ background: lightGray, padding: "72px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <h2 style={{ fontFamily: "Montserrat, sans-serif", fontSize: 24, fontWeight: 800, color: navy, marginBottom: 24, textAlign: "center" }}>
            {t("Common Mistakes", "Kesalahan Umum")}
          </h2>
