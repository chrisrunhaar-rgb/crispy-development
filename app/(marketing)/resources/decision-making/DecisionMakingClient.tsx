...
}[] = [
  {
    ...
    choices: {
      A: {
        ...
        nl: "Haal eerst de feiten op — aanwezigheidsgegevens, e-mailreactietijden, projectmijlpaalupdates. Je wilt data v——r interpretatie.",
      },
      C: {
  ...
  },
  {
    ...
    choices: {
      ...
      D: {
        ...
        nl: "Maak nu een voorlopige rolverheldering en circuleer die. Je kunt later bijsturen — ambigu—teit kost al meer dan onvolmaaktheid.",
      },
    },
  },
  {
...
const PROFILES: Record<ProfileKey, {
  ...
  decisive: {
    ...
    nl_strength: "Je doorsnijdt ambigu—teit. Je team weet waar je staat. Beslissend leiderschap vermindert angst en koersverlies — jouw duidelijkheid is een echte gave voor de mensen die je leidt.",
      ...
      <div style={{ background: navy, padding: "64px 24px 80px" }}>
        ...
        <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 16, color: "oklch(78% 0.04 260)", maxWidth: 540, margin: "0 auto", lineHeight: 1.7 }}>
          {t(
            ...
            "Vier keuzes. ——n crisis. Wat jouw beslissingen onthullen over hoe jij werkelijk leidt."
          )}
        </p>
      </div>
