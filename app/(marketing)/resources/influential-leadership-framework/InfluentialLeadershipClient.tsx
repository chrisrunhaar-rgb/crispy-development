...
const PILLARS: Pillar[] = [
  {
    ...
    nl_nextstep:
      "Identificeer ——n afspraak die je deze week hebt gemaakt maar nog niet bent nagekomen. Kom die na — of heronderhandel eerlijk voordat de deadline verstrijkt.",
  },
  {
    num: 2,
    en_title: "Connection",
    ...
    nl_depletes: [
      "Relationele investering als ineffici—nt behandelen. Leiders die 'te druk zijn voor mensen' ontdekken dat mensen te onverschillig worden om te volgen.",
    ...
    nl_nextstep:
      "Kies ——n teamlid dat je het minst kent als persoon. Stel hen deze week ——n oprechte vraag — niet over werk.",
  },
  {
    num: 3,
    ...
    nl_desc:
      "Invloed hangt volledig af van of je boodschap aankomt. Communiceren over culturen heen is niet alleen vertalen — het is begrijpen hoe directheid, toon, stilte, hi—rarchie en context bepalen of mensen horen wat je werkelijk bedoelt. De technisch meest correcte boodschap kan volledig falen als de levering de kamer verkeerd leest.",
    en_strong: [
    ...
    nl_depletes: [
      "Gedeelde betekenis aannemen. Woorden als 'snel', 'flexibel', 'respect', 'eerlijk' en 'effici—nt' dragen in culturen sterk verschillende gewichten.",
  ...
  },
  {
    ...
    nl_strong: [
      ...
      "Je priv—gedrag en je publieke gedrag zijn hetzelfde. Wat je in de vergadering zegt, is wat je erbuiten zegt.",
    ],
    en_depletes: [
  ...
  },
  {
    ...
    nl_strong: [
      ...
      "Je kunt zitten met ambigu—teit en culturele verwarring zonder te vervallen in oordelen of terugtrekken.",
    ...
    nl_depletes: [
      ...
      "Je stijl aanpassen maar niet je aannames. Je kunt langzaam spreken en oogcontact maken terwijl je nog steeds volledig vanuit Westerse frameworks van tijd, hi—rarchie en besluitvorming opereert.",
    ],
    en_nextstep:
    ...
    nl_nextstep:
      "Identificeer ——n aanname die je momenteel maakt over hoe je team het beste werkt. Vraag jezelf af: Is dit een universeel principe of een culturele voorkeur? Controleer het dan.",
  },
];
      ...
      <div style={{ background: navy, padding: "80px 24px 72px" }}>
        ...
        >
          {t(
            ...
            "Autoriteit is een positie. Invloed is een relatie. De ——n wordt gegeven; de ander wordt gekweekt."
          )}
        </p>
        <p
          style={{
            ...
            >
              {totalScore <= 10 &&
                t(
                  ...
                  "Je staat aan het begin van het opbouwen van je invloedstoolkit. Kies de pijler met de laagste score en focus daar eerst — ——n doelbewuste oefening tegelijk."
                )}
              {totalScore > 10 &&
                totalScore <= 15 &&
                t(
