...
const RESOURCE_SLUG = "influential-leadership-framework";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <InfluentialLeadershipClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="influential-leadership-framework" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="influential-leadership-framework" />
        </div>
      </div>
    </>
  );
