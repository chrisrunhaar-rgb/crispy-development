...
const RUNGS = [
  ...
  },
  {
    ...
    detail: {
      ...
      nl: "Van ongekritiseerde aannames springen we naar conclusies — vaak snel, zelfverzekerd en als vanzelfsprekend. Deze conclusies voelen logisch, maar zijn opgebouwd op lagen gefilterde data en ge—nterpreteerde betekenis die we nooit hebben bevraagd.",
    },
    reflection: {
...
const CLIMB_DOWN_STEPS = [
  ...
  },
  {
    ...
    desc: {
      ...
      nl: "Ga terug naar de observeerbare feiten. Wat kunt u verifi—ren? Wat heeft u gefilterd? Vraag anderen wat zij hebben waargenomen. De werkelijkheid bevindt zich op de onderste sport.",
    },
  },
];
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, color: "oklch(44% 0.06 260)", marginBottom: 32, lineHeight: 1.65, maxWidth: 680 }}>
            {t(
              ...
              "Het gevaarlijkste deel van de Ladder is niet de klim — het is de lus. Onze overtuigingen be—nvloeden direct welke data we de volgende keer opmerken. Dit betekent dat onze ladder zelfdichtend kan worden: we selecteren onbewust data die bevestigt wat we al geloven.",
              lang
            )}
          </p>
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <Link href="/resources" style={{ display: "inline-block", background: "transparent", color: "oklch(85% 0.04 260)", padding: "14px 32px", borderRadius: 12, fontWeight: 600, fontSize: 14, border: "1px solid oklch(42% 0.08 260)", textDecoration: "none" }}>
              {t("Training", "Pelatihan", "Contentbibliotheek", lang)}
            </Link>
          </div>
        </div>
      </section>
