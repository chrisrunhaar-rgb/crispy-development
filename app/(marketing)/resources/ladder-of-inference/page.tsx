...
const RESOURCE_SLUG = "ladder-of-inference";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <LadderOfInferenceClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="ladder-of-inference" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="ladder-of-inference" />
        </div>
      </div>
    </>
  );
