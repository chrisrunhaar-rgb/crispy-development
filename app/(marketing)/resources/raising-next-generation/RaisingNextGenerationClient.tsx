...
const VERSES: Record<VerseKey, { en_ref: string; id_ref: string; nl_ref: string; en: string; id: string; nl: string }> = {
  "2tim-2-2": {
    en_ref: "2 Timothy 2:2", id_ref: "2 Timotius 2:2", nl_ref: "2 Timothe—s 2:2",
  ...
  "matt-28-19": {
    en_ref: "Matthew 28:19", id_ref: "Matius 28:19", nl_ref: "Matte—s 28:19",
...
const PHASES = [
  ...
  },
  {
    ...
    nl: "Investering is geen curriculum — het is een levensstijl. Paulus investeerde in Timote—s door hem te betrekken bij echte bediening (Filippenzen 2:22), hem op echte missies te sturen (1 Korinti—rs 4:17) en hem eerlijke, vormende brieven te schrijven. Ontwikkeling gebeurt in het doen, niet in het klaslokaal. Je kunt een leider niet op afstand ontwikkelen. Ze hebben nabijheid nodig — bij jouw beslissingen, jouw mislukkingen, jouw manier van omgaan met druk.",
  },
  {
    phaseId: 3,
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px 80px" }}>
              ...
              {level1Names.map((name, i) => (
                <div key={i}>
                  <input
                    ...
                    placeholder={t(`Timothy ${i + 1}`, `Timotius ${i + 1}`, `Timothe—s ${i + 1}`)}
                    style={{
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: serif, fontSize: "clamp(24px, 3.5vw, 36px)", fontWeight: 600, color: navy, marginBottom: 24, lineHeight: 1.3 }}>
            {t("The Paul—Timothy Pattern", "Pola Paulus—Timotius", "Het Paulus—Timote—s Patroon")}
          </h2>
        ...
        <div style={{ marginBottom: 64 }}>
          ...
          <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 15, color: bodyText, lineHeight: 1.8, maxWidth: 680, marginBottom: 28 }}>
            {t(
              ...
              "Paulus' strategie was nooit een bediening rondom zichzelf te bouwen. Zijn strategie was om wat hij had ontvangen toe te vertrouwen aan betrouwbare mensen die het aan anderen zouden toevertrouwen. Dit is een vier-generaties visie: Paulus ? Timote—s ? betrouwbare mensen ? anderen. De vermenigvuldiging is ingebouwd in het model. Jezus gaf dezelfde opdracht — geen gemeente, maar een beweging van leerlingmakers."
            )}
          </p>
            ...
            {([
              {
                ...
                nl: "Wie heeft op een Paulus-Timote—s manier in jou ge—nvesteerd? Wat deden zij specifiek dat je het diepst heeft gevormd?",
              },
              {
                roman: "II",
