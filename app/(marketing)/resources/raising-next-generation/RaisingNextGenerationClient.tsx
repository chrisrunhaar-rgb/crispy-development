...
const VERSES: Record<VerseKey, { en_ref: string; id_ref: string; en: string; id: string }> = {
  "2tim-2-2": {
    en_ref: "2 Timothy 2:2", id_ref: "2 Timotius 2:2",
  ...
  "matt-28-19": {
    en_ref: "Matthew 28:19", id_ref: "Matius 28:19",
...
const PHASES = [
  ...
  {
    phaseId: 2,
    en_label: "Invest", id_label: "Investasi",
    en_subtitle: "Do as I do", id_subtitle: "Lakukan seperti yang kulakukan",
              ...
              return (
                <div key={vKey} style={{ padding: "28px 28px", background: lightGray, borderRadius: 10 }}>
                  <p style={{ fontFamily: serif, fontSize: 19, fontStyle: "italic", color: navy, lineHeight: 1.7, marginBottom: 16 }}>
                    "{lang === "en" ? v.en : lang === "id" ? v.id : v.id}"
                  </p>
                  <button onClick={() => setActiveVerse(vKey)} style={{
                    ...
                    {lang === "en" ? v.en_ref : lang === "id" ? v.id_ref : v.id_ref}
                  </button>
                </div>
              );
            })}
        ...
        <div onClick={() => setActiveVerse(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <p style={{ fontFamily: serif, fontSize: 22, lineHeight: 1.65, color: navy, fontStyle: "italic", marginBottom: 16 }}>
              "{lang === "en" ? VERSES[activeVerse].en : lang === "id" ? VERSES[activeVerse].id : VERSES[activeVerse].id}"
            </p>
            <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 13, fontWeight: 700, color: orange, letterSpacing: "0.08em", marginBottom: 24 }}>
              — {lang === "en" ? VERSES[activeVerse].en_ref : lang === "id" ? VERSES[activeVerse].id_ref : VERSES[activeVerse].id_ref} {lang === "en" ? "(NIV)" : "(TB)"}
            </p>
