    ...
    return (
      <div>
        ...
        <section style={{
          ...
          <img src="/images/resources/5languages/hero.jpg" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", opacity: 0.18, mixBlendMode: "luminosity", pointerEvents: "none" }} />
