...
export default function BigFiveClient({
                    ...
                    <div>
                      ...
                      <div style={{ marginTop: 12, display: "flex", alignItems: "center", gap: 8 }}>
                        <span style={{ fontFamily: "var(--font-montserrat), Montserrat, sans-serif", fontSize: 11, fontWeight: 700, color: trait.color, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                          {lang === "id" ? "Refleksi Alkitab" : "Biblical Reflection"}
                        </span>
        ...
        <div style={{ background: "oklch(95% 0.008 80)", padding: "80px 24px" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-montserrat), Montserrat, sans-serif", fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 800, color: "oklch(22% 0.10 260)", marginBottom: 32, lineHeight: 1.2 }}>
              {lang === "id" ? "Big Five: Panduan Lintas Budaya untuk Pemimpin Global" : "The Big Five Personality Traits Explained: A Cross-Cultural Guide for Global Leaders"}
            </h2>
            <button
  ...
  if (quizState === "active") {
    ...
    const qText = lang === "id" ? q.text_id : q.text;
      ...
      <div style={{ background: "white", borderTop: "3px solid oklch(88% 0.006 260)", padding: "40px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
          <p style={{ fontFamily: "var(--font-montserrat), Montserrat, sans-serif", fontSize: 13, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "oklch(45% 0.06 280)", margin: 0 }}>
            {lang === "id" ? "Bentuk Profil OCEAN Anda" : "Your OCEAN Profile Shape"}
          </p>
          <OceanRadarSVG
