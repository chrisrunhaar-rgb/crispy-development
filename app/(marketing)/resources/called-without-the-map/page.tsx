...
import CalledWithoutMapClient from "./CalledWithoutMapClient";

export const dynamic = "force-dynamic";

const RESOURCE_SLUG = "called-without-the-map";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      />
      <Script
        id="sl-called-without-map-ga-tracking"
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "Called Without the Map" },
            ]}
          />
        </div>
      </div>

      <CalledWithoutMapClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="called-without-the-map" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="called-without-the-map" />
        </div>
      </div>
    </>
  );
