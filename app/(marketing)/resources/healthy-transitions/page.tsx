...
const RESOURCE_SLUG = "healthy-transitions";
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "Healthy Transitions" },
            ]}
          />
        </div>
      </div>

      <HealthyTransitionsClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="healthy-transitions" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="healthy-transitions" />
        </div>
      </div>
    </>
  );
