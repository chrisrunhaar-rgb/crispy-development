  ...
  return (
    <div style={{ fontFamily: "Montserrat, sans-serif", background: "oklch(97% 0.005 260)", minHeight: "100vh" }}>
      ...
      <section style={{ background: "oklch(22% 0.10 260)", padding: "80px 24px 72px", position: "relative", overflow: "hidden" }}>
        <img src="/images/resources/wheel-of-life/hero.jpg" alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover", objectPosition: "center", opacity: 0.18, mixBlendMode: "luminosity", pointerEvents: "none" }} />
