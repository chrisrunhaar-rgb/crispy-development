...
const UI: Record<string, T3> = {
  ...
  caveatBody:            {
    ...
    nl: "Het Enneagram heeft wortels in pre-christelijke wijsheidstradities en sommige evangelische stemmen zijn voorzichtig met het gebruik ervan. De versie ontwikkeld door Riso,³ Hudson,³ Rohr⁴ en anderen is een breed gebruikt geestelijk en psychologisch kader — geen spirituele praktijk. Gebruikt als zelfkennisinstrument is het theologisch neutraal. Houd het als een spiegel, niet als een meester. Lees uw resultaat als een hypothese over uw motivaties, niet als een oordeel over uw ziel.",
  },
  ...
  enneagramP2:           {
    ...
    nl: "Het woord komt van het Griekse ennea (negen) en gramma (iets geschrevens). Het beschrijft negen onderscheiden persoonlijkheidstypes, elk gevormd door een kernmotivatie en een kernangst die onder het oppervlak van het zelfbewustzijn werken. Het systeem vindt zijn moderne vorm bij Oscar Ichazo,¹ die het introduceerde aan het Arica Instituut in de jaren 1960–1970, en werd psychologisch ontwikkeld door Claudio Naranjo.² Don Richard Riso en Russ Hudson³ en Richard Rohr⁴ vormden het tot het kader dat vandaag het meest gebruikt wordt in leiderschap en spirituele vorming.",
  },
  enneagramP3:           {
