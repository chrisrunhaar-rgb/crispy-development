...
const RESOURCE_SLUG = "storytelling-leadership";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      />
      <Script
        id="sl-storytelling-ga-tracking"
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "Storytelling Leadership" },
            ]}
          />
        </div>
      </div>

      <StorytellingLeadershipClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="storytelling-leadership" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="storytelling-leadership" />
        </div>
      </div>
    </>
  );
