...
const VERSES = {
  "1-kings-11-4": {
    en_ref: "1 Kings 11:4", id_ref: "1 Raja-raja 11:4",
  ...
  "1-sam-15-17": {
    en_ref: "1 Samuel 15:17", id_ref: "1 Samuel 15:17",
  ...
  "dan-6-10": {
    en_ref: "Daniel 6:10", id_ref: "Daniel 6:10",
  ...
  "2-tim-4-7": {
    en_ref: "2 Timothy 4:7", id_ref: "2 Timotius 4:7",
  ...
  "john-15-4-5": {
    en_ref: "John 15:4—5", id_ref: "Yohanes 15:4—5",
  ...
  "ps-46-10": {
    en_ref: "Psalm 46:10", id_ref: "Mazmur 46:10",
  ...
  "1-kings-19-4": {
    en_ref: "1 Kings 19:4", id_ref: "1 Raja-raja 19:4",
  ...
  "col-2-8": {
    en_ref: "Colossians 2:8", id_ref: "Kolose 2:8",
...
const DRIFTS = [
  ...
  },
  {
    ...
    en_practice: "Identify one person, not a subordinate or a fan, but a spiritual peer, and reach out to them this week. Not to network. Not to update them on your work. Simply to say: I need someone who can pray with me. Then let them.",
    id_practice: "Identifikasi satu orang, bukan bawahan atau penggemar, tetapi rekan rohani, dan hubungi mereka minggu ini. Bukan untuk jaringan. Bukan untuk memperbarui mereka tentang pekerjaan Anda. Cukup untuk mengatakan: Saya butuh seseorang yang bisa berdoa bersama saya. Kemudian biarkan mereka.",
  },
  {
    number: "05",
    ...
    en_signs: [
      ...
      "You haven't had a serious theological conversation in months, and it feels too risky",
    ],
    id_signs: [
      ...
      "Anda belum memiliki percakapan teologis serius selama berbulan-bulan, dan rasanya terlalu berisiko",
    ],
    verse_key: "col-2-8",
    en_biblical: "Daniel",
    id_biblical: "Daniel",
    ...
    en_soul_question: "What belief or practice in your current context are you afraid to examine? You might find it has already shaped you more than Scripture has.",
    id_soul_question: "Keyakinan atau praktik apa dalam konteks Anda saat ini yang Anda takut periksa? Anda mungkin menemukan bahwa itu telah membentuk Anda lebih dari Kitab Suci.",
          ...
          <div key={drift.number} style={{ background: bg }}>
            ...
            <div style={{ padding: "96px 24px", maxWidth: 720, margin: "0 auto" }}>
              ...
              <p style={{ fontFamily: serif, fontSize: "clamp(17px, 2vw, 20px)", color: bodyText, lineHeight: 1.9, marginBottom: 56, padding: "0 0 0 24px", borderLeft: `3px solid ${orange}` }}>
                {lang === "id" ? drift.id_narrative : drift.en_narrative}
              </p>
              ...
              <div style={{ marginBottom: 56 }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {(lang === "id" ? drift.id_signs : drift.en_signs).map((sign, si) => (
              ...
              <div style={{ marginBottom: 48 }}>
                <p style={{
                  ...
                  {lang === "id" ? drift.id_verse_display : drift.en_verse_display}
                </p>
      ...
      <div style={{ background: navy, padding: "104px 24px 96px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 11, fontWeight: 700, color: orange, letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 32, textAlign: "center" }}>
            {t("Remaining in the Vine", "Tinggal dalam Pokok Anggur")}
          </p>
          ...
          <h2 style={{ fontFamily: serif, fontSize: "clamp(30px, 4vw, 52px)", fontWeight: 700, color: offWhite, marginBottom: 48, lineHeight: 1.2, fontStyle: "italic", textAlign: "center" }}>
            {t("What Abiding Looks Like While Leading", "Seperti Apa Tinggal dalam Kristus Selagi Memimpin")}
          </h2>
          ...
          <div style={{ marginBottom: 56, textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 12, fontWeight: 700, color: orange, letterSpacing: "0.08em" }}>
              — <VerseRef id="john-15-4-5">{t("John 15:4—5", "Yohanes 15:4—5")}</VerseRef> (NIV)
            </p>
          </div>
          ...
          <div style={{ background: "oklch(18% 0.09 260)", padding: "48px 44px", borderRadius: 4, marginTop: 64 }}>
            <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 11, fontWeight: 700, color: orange, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 20 }}>
              {t("A final witness — Paul", "Satu saksi terakhir — Paulus")}
            </p>
            ...
            <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 12, fontWeight: 700, color: orange, letterSpacing: "0.08em", marginBottom: 28 }}>
              — <VerseRef id="2-tim-4-7">{t("2 Timothy 4:7", "2 Timotius 4:7")}</VerseRef> (NIV)
            </p>
          ...
          <div style={{ marginTop: 72, textAlign: "center" }}>
            <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: 11, fontWeight: 700, color: orange, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 32 }}>
              {t("A prayer of surrender", "Doa penyerahan diri")}
            </p>
