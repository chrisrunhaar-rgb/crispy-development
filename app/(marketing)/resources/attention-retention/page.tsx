...
const RESOURCE_SLUG = "attention-retention";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <AttentionRetentionClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="attention-retention" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="attention-retention" />
        </div>
      </div>
    </>
  );
