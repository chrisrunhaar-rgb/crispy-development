...
const GREEN_PHRASES_NL = [
  ...
  "Zelfs wilde idee—n zijn nu welkom.",
  "Laten we blijven toevoegen voordat we evalueren.",
  "Er zijn geen slechte idee—n in deze fase.",
...
const RED_PHRASES_NL = [
  ...
  "Wat zijn de potenti—le nadelen of obstakels?",
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                            <button
                              ...
                              style={{
                                padding: "8px 20px", borderRadius: 12, fontSize: 13, fontWeight: 700, cursor: quizSubmitted ? "default" : "pointer",
