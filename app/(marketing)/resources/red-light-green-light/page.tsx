...
const RESOURCE_SLUG = "red-light-green-light";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <RedLightGreenLightClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="red-light-green-light" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="red-light-green-light" />
        </div>
      </div>
    </>
  );
