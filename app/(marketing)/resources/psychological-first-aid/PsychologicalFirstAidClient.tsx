...
const RAPID_STEPS: {
  ...
  },
  {
    ...
    nl_desc: "Wanneer de persoon gehoord is, beoordeel de situatie zacht. Wat voor crisis is dit � trauma, paniek, rouw, burnout-instorting, een veiligheidsincident? Zijn er directe fysieke gevaren? Zijn er anderen betrokken? Hoe stabiel is de persoon nu? Dit is geen verhoor � het is ge�nformeerde aanwezigheid.",
    ...
    nl_example: "\"Op een schaal van 1�10, hoe veilig voel je je nu?\" of \"Is er iemand anders die be�nvloed is door wat er is gebeurd waar we aan moeten denken?\"",
  ...
  },
  {
    ...
    nl_avoid: "Probeer de hele crisis niet in ��n gesprek op te lossen. Laat urgentie de helderheid niet overstijgen. Prioriteer je eigen ongemak niet � focus op hun behoefte.",
  },
  {
    key: "I",
...
const CULTURAL_NOTES: {
...
}[] = [
  {
    ...
    nl_practical: "Ga eerst naar een priv�ruimte. Gebruik indirecte taal: 'Je lijkt vandaag iets zwaar te dragen.' Laat hen het tempo van de openbaring bepalen.",
  },
  {
    key: "collective",
    icon: "??",
    ...
    nl_body: "In collectivistische culturen � het grootste deel van Sub-Sahara Afrika, Zuidoost-Azi� en Latijns-Amerika � ervaart iemand geen crisis alleen. De familie, het team, de gemeenschap zijn allemaal deel van wat er gebeurt. Individuele crisisbegeleiding in Westerse stijl kan isolerend of zelfs onterend aanvoelen. Herstel gebeurt vaak in en door de gemeenschap, niet los ervan.",
  ...
  },
  {
    ...
    nl_title: "Sto�sche Culturen: Let op Vertraagde Reactie",
...
const BOUNDARY_ITEMS: {
...
}[] = [
  {
    ...
    nl_signal: "De persoon toont tekenen van klinisch trauma, depressie of su�cidaliteit.",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 20 }}>
            {[
              ...
              },
              {
                ...
                nl_body: "Kalme, meelevende aanwezigheid. Praktische ori�ntatie. Onmiddellijke veiligheid. Emotionele erkenning. Slimme doorverwijzing. Leiders die dit goed kunnen doen vervangen geen professionals � ze zijn het verschil tussen een crisis die escaleert of ingedamd wordt.",
              },
            ].map((item, i) => (
