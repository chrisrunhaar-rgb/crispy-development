...
const RESOURCE_SLUG = "psychological-first-aid";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <PsychologicalFirstAidClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="psychological-first-aid" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="psychological-first-aid" />
        </div>
      </div>
    </>
  );
