...
const RESOURCE_SLUG = "conflict-resolution";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <ConflictResolutionClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="conflict-resolution" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="conflict-resolution" />
        </div>
      </div>
    </>
  );
