...
const RESOURCE_SLUG = "escaping-the-comfort-zone";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <ComfortZoneClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="escaping-the-comfort-zone" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="escaping-the-comfort-zone" />
        </div>
      </div>
    </>
  );
