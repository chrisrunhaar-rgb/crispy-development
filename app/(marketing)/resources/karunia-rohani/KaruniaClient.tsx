          ...
          <div style={{ background: BG_LIGHT, padding: "3rem 1.5rem" }} className="no-print">
            <div style={{ maxWidth: "720px", margin: "0 auto" }}>
              ...
              <p style={{ fontSize: "0.72rem", color: "oklch(62% 0.008 260)", lineHeight: 1.6, borderTop: `1px solid ${BORDER}`, paddingTop: "1.5rem" }}>
                {lang === "id"
                  ? <><sup style={{ fontSize: "0.65rem", color: "oklch(65% 0.15 45)", fontWeight: 700 }}>⁴</sup> Diadaptasi dari Jim Burns &amp; Doug Fields, &ldquo;The Word on Finding and Using Your Spiritual Gifts&rdquo;</>
                  : <><sup style={{ fontSize: "0.65rem", color: "oklch(65% 0.15 45)", fontWeight: 700 }}>⁴</sup> Adapted from Jim Burns &amp; Doug Fields, &ldquo;The Word on Finding and Using Your Spiritual Gifts&rdquo;</>}
              </p>
            </div>
          </div>
