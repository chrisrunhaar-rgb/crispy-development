        ...
        <div className="container-wide" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "3rem", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontFamily: "var(--font-montserrat)", fontSize: "0.9375rem", lineHeight: 1.75, color: "oklch(42% 0.008 260)", marginBottom: "2rem", maxWidth: "48ch" }}>
              {t(
                "Leaders are Readers is one of many resources in the Crispy Leaders training library — built for field workers and cross-cultural leaders.",
                "Pemimpin adalah Pembaca adalah salah satu dari banyak sumber daya di perpustakaan pelatihan Crispy Leaders — dibangun untuk pekerja lintas budaya dan pemimpin lintas budaya.",
