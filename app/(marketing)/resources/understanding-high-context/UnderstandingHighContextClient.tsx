...
const DIMENSIONS = [
  {
    ...
    spectrum: [
      ...
      { en_label: "Brazil", id_label: "Brasil", nl_label: "Brazili—", position: 48 },
      { en_label: "Nigeria", id_label: "Nigeria", nl_label: "Nigeria", position: 58 },
      { en_label: "Japan", id_label: "Jepang", nl_label: "Japan", position: 78 },
      { en_label: "Indonesia", id_label: "Indonesia", nl_label: "Indonesi—", position: 82 },
    ...
    nl_scenario_high: "Budi bekijkt hetzelfde rapport en zegt vriendelijk: \"Dit is een goede poging. Ik vraag me af of we ook naar de financi—le kant kunnen kijken — ik denk dat er iets de moeite waard kan zijn om te verkennen v——r de deadline.\" Hij pauzeert. Hij wacht. De boodschap is er — voor wie weet te luisteren.",
    ...
    nl_practice: "Als je met indirecte communicatoren werkt: vertraag, stel verhelderende vragen, laat stilte na feedback. De echte reactie kan uren later komen, priv—. Verwis rust niet met instemming.",
  ...
  },
  {
    ...
    spectrum: [
      { en_label: "Australia", id_label: "Australia", nl_label: "Australi—", position: 12 },
    ...
    nl_practice: "Let in hoge-context omgevingen op wat de woorden omringt: wie er in de kamer is, de spreekvolgorde, het gebruik van verhalen en analogie—n. Deze dragen betekenis die de woorden alleen niet dragen.",
  ...
  },
  {
    ...
    spectrum: [
      ...
      { en_label: "Saudi Arabia", id_label: "Arab Saudi", nl_label: "Saudi-Arabi—", position: 72 },
      { en_label: "Indonesia", id_label: "Indonesia", nl_label: "Indonesi—", position: 80 },
  ...
  },
  {
    ...
    spectrum: [
      ...
      { en_label: "Australia", id_label: "Australia", nl_label: "Australi—", position: 15 },
      { en_label: "UK", id_label: "Inggris", nl_label: "VK", position: 20 },
      { en_label: "Brazil", id_label: "Brasil", nl_label: "Brazili—", position: 42 },
      { en_label: "Philippines", id_label: "Filipina", nl_label: "Filipijnen", position: 70 },
      { en_label: "Indonesia", id_label: "Indonesia", nl_label: "Indonesi—", position: 78 },
    ...
    nl_bridge: "Vraag jezelf voor feedback geven af: \"Beschermt of blootstelt dit de persoon?\" Kies priv—omgevingen. Formuleer correctie als investering, niet als beschuldiging. Het doel is de relatie EN de standaard — niet ——n ten koste van de ander.",
  },
  {
    id: "time",
    ...
    nl_practice: "Als je monochronisch werkt met polychronische collega's: bouw buffer in je schema voor relatietijd — dat is geen ineffici—ntie, dat is de prijs van vertrouwen. Als je polychronisch werkt met monochronische leiders: geef vooraf aan wanneer het uitloopt.",
    ...
    nl_bridge: "Herformuleer: tijd vroeg ge—nvesteerd in mensen bespaart tijd die later verloren gaat aan misverstanden, conflicten en vertrouwensherstel. De polychronische vergadering die uitloopt is soms de effici—ntste langetermijninvestering.",
  },
];
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        nl: "De persoon priv— apart te nemen — hun waardigheid beschermen weegt zwaarder",
        style: "high",
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        nl: "Ok— — het gesprek was duidelijk de moeite waard",
        style: "high",
      },
    ],
  },
    ...
    options: [
      {
        ...
        nl: "Elk detail uit te schrijven — ambigu—teit cre—ert problemen",
        style: "low",
      },
      {
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "56px 24px 40px" }}>
        ...
        <p style={{ fontSize: 17, lineHeight: 1.8, color: bodyText }}>
          {t(
            ...
            "Deze module verkent vijf dimensies waar hoge-context en lage-context benaderingen echte wrijving cre—ren voor leiders. Voor elke dimensie zie je waar wereldregio's doorgaans op het spectrum vallen, twee scenario's die dezelfde leiderschapssituatie anders aanpakken, en een praktische brug om de kloof te overbruggen."
          )}
        </p>
      </div>
        ...
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.85, color: "oklch(82% 0.02 80)", marginBottom: 36 }}>
            {t(
              ...
              "En toch, toen Paulus aan de Korinti—rs schreef — een kosmopolitisch, Grieks sprekend, laagcontext publiek — redeneerde hij. Hij maakte proposities. Hij legde logica uit. Dezelfde man, hetzelfde evangelie, zijn communicatiestijl aanpassend aan de culturele context. Geen compromis. Incarnatie."
            )}
          </p>
              ...
              <>
                ...
                <p style={{ fontSize: 15, lineHeight: 1.75, color: "oklch(78% 0.02 80)", margin: 0 }}>
                  {t(
                    ...
                    "Je neigt naar directheid, maar hebt ook enige instincten voor relationele gevoeligheid. In interculturele situaties, vertrouw die instincten meer — het ongemak van ambigu—teit is vaak het toegangspunt voor vertrouwen."
                  )}
                </p>
              </>
            )}
        ...
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 15, lineHeight: 1.75, color: bodyText, marginBottom: 32 }}>
            {t(
              ...
              "Hoge-context en lage-context communicatie is ——n dimensie van een veel groter geheel. Verken de gerelateerde modules hieronder."
            )}
          </p>
