...
const frictionPoints = [
  {
    ...
    nl_body: "In hoge PD-culturen daagt een teamlid een leider zelden publiekelijk uit — zeker niet in een groep. Stilte en knikken betekenen niet 'Ik ben het eens.' Ze betekenen vaak 'Ik respecteer je te veel om je hier te tegenspreken.' Echte feedback, als die al komt, komt priv—, indirect, en veel later.",
    ...
    nl_practice: "Cre—er priv—kanalen voor eerlijke feedback — een ——n-op-——n na de vergadering, een schriftelijk formulier, of een vertrouwde tussenpersoon. Maak het veilig om het oneens te zijn zonder dat het een publieke daad is.",
  },
  {
    number: "02",
    ...
    nl_practice: "Behoud zichtbaar, rustig gezag — neem duidelijke beslissingen, communiceer ze helder, en cre—er structuur. Je kunt nog steeds warm en relationeel zijn zonder verwarring te cre—ren over wie er leidt.",
  },
  {
    number: "03",
    ...
    nl_practice: "Vraag voordat je vertelt. Deel je perspectief als laatste, niet als eerste. Of stel een specifieke, gerichte vraag: 'Wat is ——n risico dat we nog niet hebben overwogen?' in plaats van 'Wat denken jullie allemaal?'",
  },
  {
    number: "04",
    ...
    nl_body: "In veel hoge PD-culturen wordt formeel gezag gerespecteerd — maar het gaat slechts zo ver. Echte invloed, waarbij mensen het extra voor je doen, vereist relationeel vertrouwen. Als je geen tijd hebt ge—nvesteerd in je team persoonlijk kennen — hun families, zorgen, achtergrond — heb je misschien hun gehoorzaamheid maar niet hun toewijding.",
    ...
    nl_practice: "Investeer in ——n-op-——n tijd met elk teamlid — niet over werk, maar over hen. Leer namen, families, verhalen kennen. In de meeste hoge PD-culturen is de leider die zijn mensen kent de leider die mensen zullen volgen.",
  },
];
...
const reflectionQuestions = [
  ...
  },
  {
    ...
    nl: "Wie in je team doet momenteel het meeste culturele aanpassingswerk? Is die last eerlijk verdeeld — of draagt ——n persoon het grootste deel?",
  },
  {
    roman: "V",
    ...
    nl: "Op welke manieren kan je huidige leiderschapsstijl verwarring of angst in je team cre—ren — zonder dat je het beseft?",
  },
];
...
const hofstedeLimitations = [
  {
    ...
    body: {
      ...
      nl: "Hofstede's data is afkomstig van IBM-medewerkers die werden ondervraagd tussen 1967 en 1973. De steekproef was groot — 117.000 mensen in meer dan 50 landen — maar volledig afkomstig van ——n multinational. IBM-medewerkers vertegenwoordigen mogelijk niet hun bredere thuisculturen. Brendan McSweeney's kritiek uit 2002 in Human Relations blijft een van de sterkste: de steekproef was structureel bevooroordeeld en sommige landen hadden minder dan 200 respondenten.",
    },
  },
  {
    number: "2",
...
const globeScores = [
  ...
  { country: { en: "Indonesia", id: "Indonesia", nl: "Indonesi—" }, asIs: 5.18, shouldBe: 2.49 },
  { country: { en: "Australia", id: "Australia", nl: "Australi—" }, asIs: 4.74, shouldBe: 2.49 },
...
const meyerFramework = {
  ...
  body: {
    ...
    nl: "Erin Meyers raamwerk brengt culturele verschillen in kaart langs acht schalen. Twee zijn hier het meest relevant. De Leading-schaal loopt van egalitair naar hi—rarchisch — direct gebouwd op Hofstede's PDI en GLOBE-data. De Deciding-schaal loopt van consensueel naar top-down. Ze zijn niet hetzelfde, en veel culturen vallen in onverwachte combinaties. Duitsers zijn hi—rarchischer dan Amerikanen op de Leading-schaal — maar meer consensueel op de Deciding-schaal. Japan is beroemd hi—rarchisch en tegelijkertijd diep consensueel: het ringi-systeem vereist consensusvorming op lagere niveaus voordat voorstellen ooit bij senior leiders terechtkomen.",
  },
  implication: {
...
const hallFramework = {
  ...
  implication: {
    ...
    nl: "In hoge-PD- en hoge-contextculturen draagt hoe je iets zegt — en wat je onuitgesproken laat — evenveel informatie als de woorden zelf. Relationeel gezag opbouwen voordat je probeert de hi—rarchie af te vlakken is niet optioneel. Het is de voorwaarde.",
  },
};
...
const insightCards = [
  ...
  },
  {
    ...
    body: {
      ...
      nl: "Hoge-PD-organisaties beslissen sneller maar brengen problemen trager naar boven. Lage-PD-organisaties beslissen trager maar vangen fouten vaker op v——r de implementatie. Geen van beide is universeel beter — de juiste balans hangt af van de kosten van mislukking. Voor beslissingen met hoge inzet en lage omkeerbaarheid — strategisch, financieel, medisch, veiligheid — leveren lage-PD-inbrengstructuren doorgaans betere resultaten.",
    },
    implication: {
  ...
  },
  {
    ...
    body: {
      ...
      nl: "Hogere machtafstand correleert met hogere tolerantie voor corruptie in landenvergelijkende studies (Husted 1999; Park 2003). Dit betekent niet dat hoge-PD-culturen uit meer corrupte mensen bestaan — het betekent dat hoge-PD-structuren minder institutionele weerstand bieden tegen corruptie als die zich voordoet. Voor christelijke organisaties: beschermingsbeleid dat afhankelijk is van een junior medewerker die wangedrag van een senior leider meldt, zal voorspelbaar mislukken in hoge-PD-omgevingen, tenzij het meldkanaal specifiek is ontworpen om de normale hi—rarchie te omzeilen.",
    },
    implication: {
      ...
      nl: "Ontwerp beschermingssystemen die de hi—rarchie structureel omzeilen — niet systemen die vertrouwen op persoonlijke moed om autoriteit uit te dagen.",
    },
  },
  {
...
const DIMENSIONS: { key: keyof CountryScore; en: string; id: string; nl: string; full_en: string }[] = [
  { key: "pdi", en: "PDI", id: "PDI", nl: "PDI", full_en: "Power Distance" },
  { key: "idv", en: "IDV", id: "IDV", nl: "IDV", full_en: "Individualism" },
  { key: "mas", en: "MAS", id: "MAS", nl: "MAS", full_en: "Masculinity" },
  { key: "uai", en: "UAI", id: "UAI", nl: "OVO", full_en: "Uncertainty Avoidance" },
  { key: "lto", en: "LTO", id: "LTO", nl: "LTO", full_en: "Long-Term Orientation" },
  { key: "ivr", en: "IVR", id: "IVR", nl: "IND", full_en: "Indulgence" },
];
        ...
        <div style={{ borderLeft: `4px solid ${orange}`, paddingLeft: 28, marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.8, marginBottom: 16 }}>
            {t(
              ...
              "In haar eerste teamvergadering legde ze drie opties voor en zei: 'Ik wil van iedereen horen. Wat denken jullie dat we moeten doen?' Stilte. Een paar beleefde knikjes. E—n man zei: 'Wat u ook beslist, wij steunen u.' Ze drong harder aan op input. Meer stilte."
            )}
          </p>
          <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.8, marginBottom: 16 }}>
            {t(
      ...
      <div style={{ padding: "80px 24px", maxWidth: 780, margin: "0 auto" }}>
        ...
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 20 }}>
          {t(
            ...
            "Machtafstand gaat er niet over of hi—rarchie goed of slecht is. Elke cultuur heeft hi—rarchie. Het verschil zit in hoe mensen erover voelen — hoeveel psychologische afstand ze verwachten tussen zichzelf en degenen in autoriteit boven hen."
          )}
        </p>
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 20 }}>
          {t(
            ...
            "In hoge machtafstandsculturen wordt ongelijkheid als natuurlijk — zelfs gezond — beschouwd. De leider zou moeten leiden. Beslissingen komen van bovenaf. Autoriteit publiekelijk uitdagen is niet alleen ongemakkelijk; het is verkeerd. De hi—rarchie geeft het team een gevoel van orde en veiligheid."
          )}
        </p>
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 36 }}>
          {t(
            ...
            "In lage machtafstandsculturen wordt hi—rarchie getolereerd maar bevraagd. Ieders stem telt. Titels maken je niet gelijk. Een goede leider verdient respect door te luisteren, niet door rang. De baas uitdagen is geen gebrek aan respect — het is betrokkenheid."
          )}
        </p>
        ...
        <div style={{ background: "oklch(97% 0.012 45)", borderLeft: `4px solid ${orange}`, borderRadius: "0 8px 8px 0", padding: "24px 28px", marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, margin: 0 }}>
            {t(
              ...
              "Voor interculturele christelijke leiders is de belangrijkste combinatie Machtafstand plus Individualisme. De meeste Aziatische, sub-Saharaanse Afrikaanse, Latijns-Amerikaanse en Midden-Oosterse culturen clusteren hoge PD en collectivistisch. De meeste Noord-Europese, Noord-Amerikaanse, Australische en Nieuw-Zeelandse culturen clusteren lage PD en individualistisch. Het samengestelde effect verklaart waarom een westerse leider die een Indonesisch of Filipijns team binnenstapt zelden met ——n dimensie worstelt — het is hoge PD plus hoog collectivisme s—men dat bepaalt wat het team van autoriteit verwacht."
            )}
          </p>
        </div>
      ...
      <div style={{ padding: "80px 24px", maxWidth: 780, margin: "0 auto" }}>
        ...
        <div style={{ background: navy, borderRadius: 12, padding: "40px 44px", marginBottom: 40, position: "relative", overflow: "hidden" }}>
          ...
          <p style={{ color: orange, fontSize: 14, fontWeight: 600, margin: 0, position: "relative" }}>
            {t("Matthew 20:26—28 (NIV)", "Matius 20:26—28", "Matthe—s 20:26—28")}
          </p>
        </div>
        ...
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 20 }}>
          {t(
            ...
            "Jezus leefde in een van de hoogste machtafstandsculturen in de antieke wereld. Romeinse bezetting. Religieuze hi—rarchie. Strikte sociale orde. Hij was geen lage-PD-leider in een lage-PD-context. Hij was een hoge-autoriteits figuur die ervoor koos macht op een volledig onverwachte manier te gebruiken."
          )}
        </p>
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 20 }}>
          {t(
            ...
            "Hij ontmantelde de hi—rarchie niet. Hij vulde haar met iets anders: liefde, opoffering en dienst. Toen hij de voeten van zijn discipelen waste (Johannes 13), deed hij niet alsof macht niet bestond — hij demonstreerde wat legitieme macht doet wanneer ze geworteld is in liefde in plaats van status."
          )}
        </p>
        ...
        <p style={{ fontSize: 16, color: bodyText, lineHeight: 1.85, marginBottom: 20 }}>
          {t(
            ...
            "Dit is belangrijk omdat de goedbedoelende westerse leider die machtafstand probeert te verkleinen door zichzelf als leider onzichtbaar te maken, gewoonlijk angst cre—ert in een hoge-PD-team, geen empowerment. Het team heeft een zichtbare leider nodig. Kenosis is geen zelfverwijdering — het is zelfgave. Het verschil bepaalt alles over hoe autoriteit wordt gebruikt."
          )}
        </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              t(
                ...
                "Als je leiding geeft aan een team met hoge machtafstand: maak deze week ——n nieuw priv—kanaal voor eerlijke feedback — een ——n-op-——nformaat of schriftelijk mechanisme dat geen publieke uitdaging vereist."
              ),
              t(
