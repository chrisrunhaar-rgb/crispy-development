...
import { Sunrise, PhoneOff, BookOpen, Mountain, PersonStanding, Users, BellOff, Ear, MessageSquare } from "lucide-react";
...
const personalCards: Array<{
  ...
  {
    icon: <Sunrise size={36} strokeWidth={1.5} color={navy} />,
  ...
  {
    icon: <BookOpen size={36} strokeWidth={1.5} color={navy} />,
    title: "Lectio Divina",
  ...
  {
    icon: <Mountain size={36} strokeWidth={1.5} color={navy} />,
  ...
  {
    icon: <PersonStanding size={36} strokeWidth={1.5} color={navy} />,
...
const teamCards: Array<{
  ...
  {
    icon: <Users size={36} strokeWidth={1.5} color={navy} />,
  ...
  {
    icon: <BellOff size={36} strokeWidth={1.5} color={navy} />,
  ...
  {
    icon: <Ear size={36} strokeWidth={1.5} color={navy} />,
  ...
  {
    icon: <MessageSquare size={36} strokeWidth={1.5} color={navy} />,
