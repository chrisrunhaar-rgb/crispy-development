...
const RESOURCE_SLUG = "returning-well";
        ...
        <div className="container-wide">
          <Breadcrumb
            items={[
              ...
              { label: "Returning Well" },
            ]}
          />
        </div>
      </div>

      <ReturningWellClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="returning-well" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="returning-well" />
        </div>
      </div>
    </>
  );
