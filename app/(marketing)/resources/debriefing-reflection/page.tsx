...
const RESOURCE_SLUG = "debriefing-reflection";
...
export default async function ResourcePage(props: any) {
  ...
  return (
    <>
      ...
      <DebriefingReflectionClient {...props} isSaved={isSaved} />
      <div className="border-t border-gray-100 py-10">
        <div className="container-wide">
          <ModuleComments slug="debriefing-reflection" />
        </div>
      </div>

      <div className="bg-gray-50 border-t border-gray-200 py-12">
        <div className="container-wide">
          <RelatedResources slug="debriefing-reflection" />
        </div>
      </div>
    </>
  );
