...
const COPY = {
  en: {
    ...
    caption: {
      ...
      video: "Modules are written for a phone screen: short sections, plain language, and something practical to try.",
  ...
  id: {
    ...
    caption: {
      ...
      video: "Modul ditulis untuk layar ponsel: bagian-bagian singkat, bahasa sederhana, dan sesuatu yang praktis untuk dicoba.",
