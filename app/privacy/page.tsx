    ...
    <div style={{ paddingBlock: "clamp(3rem, 5vw, 5rem)", background: "oklch(97% 0.005 80)" }}>
      <div className="container-text">
        ...
        <LegalSection heading="2. What Data We Collect">
          ...
          <ul>
            <li>Basic usage data when you visit our website (e.g., pages visited, time of visit). As of April 2026, no analytics platform is actively connected. If analytics tools are introduced, this policy will be updated.</li>
          </ul>
        ...
        <LegalSection heading="6. International Data Transfers">
          <p>Crispy Development is based in Malaysia. Some processors including Mailchimp are based in the United States. Where data is transferred from the EEA to a country without an EU adequacy decision, we rely on <strong>Standard Contractual Clauses (SCCs)</strong> or equivalent protections.</p>
        </LegalSection>
